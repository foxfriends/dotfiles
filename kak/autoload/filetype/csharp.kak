...
add-highlighter shared/csharp/code/ regex "\b(while|for|foreach|in|out|if|else|do|static|readonly|delegate|event|switch|case|default|class|struct|record|required|interface|enum|break|continue|return|async|await|using|namespace|try|catch|throw|new|extends|implements|throws|instanceof|finally|as|get|init|set|var|yield|const|is|not|where)\b" 0:keyword
add-highlighter shared/csharp/code/ regex "\b(final|public|protected|private|partial|abstract|internal|virtual|override)\b" 0:attribute
