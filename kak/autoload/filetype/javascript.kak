...
provide-module typescript %{
    ...
    add-highlighter shared/typescript/code/ regex \b(abstract|as|constructor|declare|enum|from|implements|interface|module|namespace|out|package|private|protected|public|readonly|static|type|satisfies|infer|is|never|override)\b 0:keyword
}
