...
provide-module sql %{
    ...
    evaluate-commands %sh{
        # Keywords
        keywords="ALTER|AS|ASC|AUTO_INCREMENT|CHECK|CONSTRAINT|CREATE OR REPLACE|CREATE|DATABASE|DEFAULT|DELETE|DESC|DISTINCT|DROP|ADD|SET DATA TYPE|EXPRESSION"
        keywords="${keywords}|EXISTS|FOREIGN KEY|FROM|FULL JOIN|FULL OUTER JOIN|GROUP BY|HAVING|INDEX|INNER JOIN|LATERAL"
