...
provide-module trilogy %§
    ...
    add-highlighter shared/trilogy/code/    regex \b(and|assert|as|at|break|cancel|continue|case|do|else|end|exit|export|false|fn|for|from|func|if|invert|in|is|let|match|module|mut|not|or|pass|proc|resume|return|rule|test|then|true|unit|when|while|with|yield)\b 1:keyword
