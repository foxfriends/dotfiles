...
provide-module trilogy %§
    ...
    add-highlighter shared/trilogy/code/    regex \b(([0-9][0-9_]*(\.[0-9_]*)?)|(0x[0-9A-Fa-f_]+)|(0o[0-7_]+)|(0b[01_]+))(i([0-9][0-9_]*(\.[0-9_]*)?)|(0x[0-9A-Fa-f_]+)|(0o[0-7_]+)|(0b[01_]+))?\b 1:value
    ...
    add-highlighter shared/trilogy/code/    regex \b(and|assert|as|at|break|cancel|continue|case|do|else|end|exit|export|fn|for|func|if|invert|in|is|let|match|module|mut|not|or|pass|proc|resume|return|rule|test|then|when|while|with|yield)\b 1:keyword
    add-highlighter shared/trilogy/code/    regex \b(async|await|catch|class|const|data|defer|enum|except|extends|implements|import|inline|instanceof|interface|lazy|lens|loop|macro|next|oper|prec|protocol|static|struct|super|switch|tag|trait|try|type|typeof|unless|until|use|var|where)\b 1:error
