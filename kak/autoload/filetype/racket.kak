...
# https://github.com/mawww/kakoune/blob/master/rc/extra/scheme.kak
# --------------------------------------------------------------------------------------------------- #
...
# --------------------------------------------------------------------------------------------------- #
# NOTE: authors first use of 'awk' and still a work in progress
# TODO: match successive operators (+ -), how/then test all those builtins
# TODO: extflonum
# --------------------------------------------------------------------------------------------------- #
...
hook global WinSetOption filetype=racket %{
    ...
    hook window ModeChange insert:.* -group racket-trim-indent lisp-trim-indent
    hook window InsertChar \n -group racket-indent lisp-indent-on-new-line

    alias window rsl racket-section-line
    
    hook -once -always window WinSetOption filetype=.* %{
      remove-hooks window racket-.+
      unalias window rsl racket-section-line
    }
}
...
provide-module racket %§
    ...
    # <https://github.com/codemirror/CodeMirror/blob/15bcf1da467b25e33ffcfd9ff877e8d8c3c3bfea/mode/scheme/scheme.js#L46>
    # --------------------------------------------------------------------------------------------------- #
    # binary
    ...
    # --------------------------------------------------------------------------------------------------- #
    # opinionated parenthesis, brackets, and braces highlighting
    # comment out or change 0:{colour} to suit your theme
    # add-highlighter shared/racket/code/ regex [()\[\]{}] 0:yellow
    # --------------------------------------------------------------------------------------------------- #
    ...
    evaluate-commands %sh{
        ...
        BEGIN {
            printf("hook global WinSetOption filetype=racket %%{ set-option window static_words ");
    ...
    # https://docs.racket-lang.org/style/Textual_Matters.html#(part._.Line_.Width)
    define-command racket-section-line -docstring 'seperate a section of code with (;; --)' %{
