...
add-highlighter shared/jinja/statement/ regex \{%[+-]?|[+-]?%\} 0:interpolation
add-highlighter shared/jinja/statement/tests regex \b(callable|even|le|none|string|defined|ge|lower|number|undefined|divisibleby|gt|lt|odd|upper|eq|mapping|sameas|escaped|iterable|ne|sequence)\b 0:builtin
...
add-highlighter shared/jinja/expression/ regex \{\{|\}\} 0:interpolation
